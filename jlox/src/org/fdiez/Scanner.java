...
class Scanner {
	...
	private boolean match(char expected){
		...
		// The "current" char is already pointing to the next char (see "advance()" where the post usage increment happen)
	...
	private char peek() {
		...
		// The "current" char is already pointing to the next char (see "advance()" as for why)
